...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.2dfdg2c.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Welcome to internet provider server .....!");
});
